...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/steep-cell-86ea#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-cell-86ea
```

A live public deployment of this template is available at [https://steep-cell-86ea.templates.workers.dev](https://steep-cell-86ea.templates.workers.dev)
